...
describe("Response handler", () => {
  ...
  describe("default response handlers", () => {
    it("should correctly throw Bad Request on 400", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Bad request");
    });
    ...
    it("should correctly throw Unauthorized on 401", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Unauthorized");
    });
    ...
    it("should correctly throw Forbidden on 403", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Forbidden");
    });
    ...
    it("should correctly throw Not found on 404", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Not found");
    });
    ...
    it("should correctly throw Not supported on 405", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Not supported");
    });
    ...
    it("should correctly throw Conflict on 409", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Conflict");
    });
    ...
    it("should correctly throw Server error on 500", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Server error");
    });
    ...
    it("should correctly throw Bad gateway on 502", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Bad gateway");
    });
    ...
    it("should correctly throw Service unavailable on 503", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Service unavailable");
    });
    ...
    it("should correctly throw a Uknown error on unknown code", () => {
      ...
      expect(() => responseHandler.handleResponse(customResponse)).toThrow("Unknown error");
    });
  });
